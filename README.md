...
* [Debian/Ubuntu AMD64 .deb](https://github.com/fwup-home/fwup/releases/download/v1.13.0/fwup_1.13.0_amd64.deb)
* [Raspbian armhf .deb](https://github.com/fwup-home/fwup/releases/download/v1.13.0/fwup_1.13.0_armhf.deb)
...
Alternatively, download the [fwup executable](https://github.com/fwup-home/fwup/releases/download/v1.13.0/fwup.exe)
and place it in your path.

If you're using another platform or prefer to build it yourself, download the
latest [source code release](https://github.com/fwup-home/fwup/releases/download/v1.13.0/fwup-1.13.0.tar.gz)
